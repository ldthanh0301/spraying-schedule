<template>
  <div class="header flex justify-evenly">
    <h2 class="header-title">Trang đăng ký</h2>
  ...
  <div class="register-form">
    <b-form @submit="onSubmit" @reset="onReset">
      ...
      <b-form-group label="Xác nhận mật khẩu:" label-for="passwordConfirm">
        <b-form-input
          id="passwordConfirm"
...
export default {
  ...
  methods: {
    onSubmit(events) {
      ...
      this.store.register({username:this.form.username,password: this.form.password,passwordConfirm: this.form.passwordConfirm})
    },
  },
};
</script>
